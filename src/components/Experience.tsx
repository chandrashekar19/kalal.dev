  ...
  const experiences = [
    {
      ...
      achievements: [
        ...
        "Orchestrated the development of a Land Management System using React, Zustand, and geospatial APIs.",
        "Delivered a 30% boost in parcel processing efficiency with intuitive visualizations and optimized workflows",
      ],
      technologies: [
        "React",
        "Javascript",
    ...
    },
    {
      ...
      description: "",
      achievements: [
        "Engineered GIS dashboards with Google Maps API and KML layers, boosting map interactivity by 25%.",
        "Integrated Street View and custom visualization tools, enhancing location and user engagement by 20%.",
      ],
      technologies: [
        "React",
        "Typescript",
